...
//import com.getbouncer.cardscan.base.ml.models.legacy.RecognizedDigitsModel;
//
...
//    }
//
//    String number(RecognizedDigitsModel model, ArrayList<ArrayList<DetectionBox>> lines) {
//        for (ArrayList<DetectionBox> line: lines) {
//            String candidateNumber = "";
//
//            for (DetectionBox word: line) {
...
//    }
//
//    private String recognizeAmexDigits(RecognizedDigitsModel model, ArrayList<DetectionBox> line) {
...
//    }
//
//    String amexNumber(RecognizedDigitsModel model, ArrayList<ArrayList<DetectionBox>> lines) {
//        for (ArrayList<DetectionBox> line: lines) {
...
//    }
//
//    private RecognizedDigits cachedDigits(RecognizedDigitsModel model, DetectionBox box) {
