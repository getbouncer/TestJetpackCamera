...
public class PriorsGen {
     ...
     * maps of only two layers, we call genPriors twice and combine the information. The
     * specification is followed as in the original paper https://arxiv.org/abs/1512.02325 by
     * Wei Liu Et al.
     */
    private static float[][] genPriors(int featureMapSize, int shrinkage, int boxSizeMin, int boxSizeMax, int aspecRatioOne, int aspectRatioTwo, int noOfPriors){
